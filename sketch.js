...
function drawMondrian(x1, y1, x2, y2, currentLevel) {
  ...
  //recursive calls
  if (r1 <= chance) drawMondrian(x1, y1, splitPointX, splitPointY, currentLevel-1);
  if (r2 <= chance) drawMondrian(splitPointX, y1, x2, splitPointY, currentLevel-1);
  if (r3 <= chance) drawMondrian(x1, splitPointY, splitPointX, y2, currentLevel-1);
  if (r4 <= chance) drawMondrian(splitPointX, splitPointY, x2, y2, currentLevel-1);
}